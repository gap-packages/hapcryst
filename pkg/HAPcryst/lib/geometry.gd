...
##
#H @(#)$Id: geometry.gd, v 0.1.8 2008/12/02 18:18:33 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/geometry_gd"):=
	"@(#)$Id: geometry.gd, v 0.1.8 2008/12/02   18:18:33  gap Exp $";
