...
##
#H @(#)$Id: CWcomplexThings_GroupRingRep.gd, v 0.1.7 2008/08/13 12:11:22 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/CWcomplexThings_GroupRingRep_gd"):=
	"@(#)$Id: CWcomplexThings_GroupRingRep.gd, v 0.1.7 2008/08/13   12:11:22  gap Exp $";
