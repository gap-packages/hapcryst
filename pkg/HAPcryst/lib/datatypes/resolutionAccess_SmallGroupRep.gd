...
##
#H @(#)$Id: resolutionAccess_SmallGroupRep.gd, v 0.1.7 2008/08/13 12:11:22 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/datatypes/resolutionAccess_SmallGroupRep_gd"):=
	"@(#)$Id: resolutionAccess_SmallGroupRep.gd, v 0.1.7 2008/08/13   12:11:22  gap Exp $";
#############################################################################
##
