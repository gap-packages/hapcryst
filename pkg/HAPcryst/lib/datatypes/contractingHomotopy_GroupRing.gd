...
##
#H @(#)$Id: contractingHomotopy_GroupRing.gd, v 0.1.7 2008/08/13 12:11:22 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/datatypes/contractingHomotopy_GroupRing_gd"):=
	"@(#)$Id: contractingHomotopy_GroupRing.gd, v 0.1.7 2008/08/13   12:11:22  gap Exp $";
