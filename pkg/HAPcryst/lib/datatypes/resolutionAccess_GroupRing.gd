...
##
#H @(#)$Id: resolutionAccess_GroupRing.gd, v 0.1.8 2008/12/02 18:18:33 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/datatypes/resolutionAccess_GroupRing_gd"):=
	"@(#)$Id: resolutionAccess_GroupRing.gd, v 0.1.8 2008/12/02   18:18:33  gap Exp $";
#############################################################################
##
