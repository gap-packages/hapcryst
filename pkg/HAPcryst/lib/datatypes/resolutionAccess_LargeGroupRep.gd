...
##
#H @(#)$Id: resolutionAccess_LargeGroupRep.gd, v 0.1.8 2008/12/02 18:18:33 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/datatypes/resolutionAccess_LargeGroupRep_gd"):=
	"@(#)$Id: resolutionAccess_LargeGroupRep.gd, v 0.1.8 2008/12/02   18:18:33  gap Exp $";
#############################################################################
##
