...
##
#H @(#)$Id: FundamentalDomain.gd, v 0.1.10 2012/04/19 20:12:51 gap Exp $
##
...
##
Revision.("/Users/roeder/gap/HAPcryst/HAPcryst/lib/FundamentalDomain_gd"):=
	"@(#)$Id: FundamentalDomain.gd, v 0.1.10 2012/04/19   20:12:51  gap Exp $";
#####################################
