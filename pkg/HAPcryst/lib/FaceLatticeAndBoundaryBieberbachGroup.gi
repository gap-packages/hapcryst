...
##
#H @(#)$Id: FaceLatticeAndBoundaryBieberbachGroup.gi, v 0.1.7 2008/08/13 12:11:22 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/FaceLatticeAndBoundaryBieberbachGroup_gi"):=
	"@(#)$Id: FaceLatticeAndBoundaryBieberbachGroup.gi, v 0.1.7 2008/08/13   12:11:22  gap Exp $";
...
######################################################################
    ...
    Polymake(poly,"FACE_LATTICE VERTICES");
