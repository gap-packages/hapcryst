...
##
#H @(#)$Id: resolutionBieberbach.gd, v 0.1.7 2008/08/13 12:11:22 gap Exp $
##
...
##
Revision.("/home/roeder/gap/HAPcryst/HAPcryst/lib/resolutionBieberbach_gd"):=
	"@(#)$Id: resolutionBieberbach.gd, v 0.1.7 2008/08/13   12:11:22  gap Exp $";
