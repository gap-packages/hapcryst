...
##
#H @(#)$Id: resolutionBieberbach.gd, v 0.1.11 2013/10/27 18:31:09 gap Exp $
##
...
##
Revision.("resolutionBieberbach_gd"):=
	"@(#)$Id: resolutionBieberbach.gd, v 0.1.11 2013/10/27   18:31:09  gap Exp $";
