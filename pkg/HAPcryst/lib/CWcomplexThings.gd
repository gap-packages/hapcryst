...
##
#H @(#)$Id: CWcomplexThings.gd, v 0.1.10 2012/04/19 20:12:51 gap Exp $
##
...
##
Revision.("/Users/roeder/gap/HAPcryst/HAPcryst/lib/CWcomplexThings_gd"):=
	"@(#)$Id: CWcomplexThings.gd, v 0.1.10 2012/04/19   20:12:51  gap Exp $";
